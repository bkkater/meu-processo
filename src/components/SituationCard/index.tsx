...
import progressBar from "~/resources/icons/progress-bar.svg";
import progressStartIcon from "~/resources/icons/progress-end-icon.svg";
import progressEndIcon from "~/resources/icons/progress-start-icon.svg";
